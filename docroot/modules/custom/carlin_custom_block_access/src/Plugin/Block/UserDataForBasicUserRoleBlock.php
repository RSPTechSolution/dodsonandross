 ...
 *
 * @Block(
 *   id = "user_data_for_basic__user_role",
 *   admin_label = @Translation("User Data For Basic User Role"),
 *   category = @Translation("User Data For Basic User Role")
 * )
 */

class UserDataForBasicUserRoleBlock extends BlockBase {
